...
class TransliterationMapping:
    ...
    Attributes:
        ...
        char_mappings: List of (original_start, original_end,
            transliterated_start, transliterated_end)
    ...
    def get_transliterated_offset(self, original_pos: int) -> int:
        ...
        """
        for orig_start, orig_end, trans_start, _trans_end in self.char_mappings:
    ...
    def get_token_offsets(self, token_start: int, token_end: int) -> tuple[int, int]:
        ...
        if orig_end >= 0:
            ...
            for _o_start, o_end, t_start, t_end in self.char_mappings:
...
class OttomanTransliterator:
    ...
    def arabic_to_modern(self, text: str) -> TransliterationMapping:
        ...
        combined_mappings = []
        for orig_start, orig_end, schol_start, schol_end in (
            scholarly_mapping.char_mappings
        ):
            ...
            if modern_end >= 0:
                ...
                for s, _e, _ms, me in modern_mapping.char_mappings:
                    if s == schol_end - 1:
                        modern_end = me
                        break
            ...
            if modern_start >= 0:
                combined_mappings.append(
                    (orig_start, orig_end, modern_start, modern_end)
                )
